import Taro, { vibrateLong } from '@tarojs/taro'
  ...
  render() {
    ...
    return (
      <View className="search-page">
        <View className="search">
          ...
          <ScrollView className="scroll" scrollY scrollWithAnimation>
            {suggestList.map((item) => {
              return (
                <View className="scroll-item" key={item.id} onClick={this.handleSuggestClick}>
                  {item.name}
                </View>
              );
            })}
        ...
        {historyList.length ? (
          <View className="list-wrapper history-list">
            ...
            <View className="list">
              {historyList.map((item) => {
                return (
                  <View className="list-item history-item" key={item.keyword}>
        ...
        <View className="list-wrapper hot-list">
          ...
          <View className="list">
            {hotList.map((item) => {
              return (
                <View className="list-item hot-item" key={item.keyword}>
                  <View onClick={() => this.searchWord(item.keyword)}>
                    {item.keyword}
                  </View>
                </View>
                      ...
                      <View className="tab">
                        {
                          tabs.map((item, index) => {
                            return (
                              <View className="tab-item" key={ item } onClick={() =>this.switchTap(index)}>
                      ...
                      <View className="goods-list">
                        {
                          goodsList.map(item => {
                            return (
                              <View className="list-item" key={ item.id } onClick={() => this.toGoodsDetail(item.id)}>
