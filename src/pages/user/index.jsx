...
export default class User extends Taro.Component {
  ...
  getUserInfo = (e) => {
    ...
    Taro.setStorageSync('userinfo', e.detail.rawData)
    this.setState({
        ...
        <View className="user-info">
          {
            rawData ? 
              ...
              :
              <Button type="primary" size="mini" className="btn" plain openType="getUserInfo" onGetUserInfo={ this.getUserInfo }>登录</Button>
          }
        </View >
      <View className="main">
