...
import Taro, { getStorageSync as _getStorageSync, showToast as _showToast, chooseAddress as _chooseAddress } from "@tarojs/taro-h5";
...
export default class AddAddress extends Taro.Component {
  ...
  render() {
    ...
    return <View className="add-address">
