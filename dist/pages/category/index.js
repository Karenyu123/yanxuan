...
/***/ "./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/pages/category/index.jsx?taro&type=script&parse=PAGE&":
/*!****************************************************************************************************************************************************!*\
  !*** ./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/pages/category/index.jsx?taro&type=script&parse=PAGE& ***!
  \****************************************************************************************************************************************************/
...
__webpack_require__(/*! ./index.less */ "./src/pages/category/index.less");
...
var Catogory = (_temp2 = _class = function (_Taro$Component) {
  ...
  function Catogory() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Catogory.__proto__ || Object.getPrototypeOf(Catogory)).call.apply(_ref, [this].concat(args))), _this), _this.$usedState = ["loopArray24", "loopArray25", "currentIndex", "listData", "currentCategory", "categorylist"], _this.state = {
      listData: [],
      currentIndex: 0,
      currentCategory: {}
    }, _this._getListData = _asyncToGenerator( /*#__PURE__*/_regenerator2.default.mark(function _callee() {
      var data;
      return _regenerator2.default.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              _context.next = 2;
              return (0, _request.request)({ url: '/category/indexaction' });
            ...
            case 2:
              ...
              _this.setState({
                ...
                _this._getCategoryList(_this.state.listData[0].id);
              });
    ...
    })), _this._getCategoryList = function () {
        ...
        return _regenerator2.default.wrap(function _callee2$(_context2) {
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                _context2.next = 2;
                return (0, _request.request)({ url: '/category/currentaction', data: { id: id } });
    ...
    }(), _this.switchNav = function (id, index) {
      _this.setState({
        currentIndex: index
      });
      _this._getCategoryList(id);
  ...
  _createClass(Catogory, [{
    ...
    value: function _createData() {
      ...
      var categorylist = currentCategory.subList || [];
      var loopArray24 = listData.map(function (item, index) {
        item = {
        ...
        _this3.anonymousFunc0Map[_$indexKey] = function () {
          return _this3.switchNav(item.$original.id, index);
        };
      ...
      var loopArray25 = categorylist.map(function (item, __index1) {
        item = {
          $original: (0, _taroWeapp.internal_get_original)(item)
        };

        var _$indexKey2 = "bdzzz" + __index1;

        _this3.anonymousFunc1Map[_$indexKey2] = function () {
          return _this3.toCategorylist(item.$original.id);
        };
  ...
  return Catogory;
}(_taroWeapp2.default.Component), _class.$$events = ["toSearch", "anonymousFunc0", "anonymousFunc1"], _class.$$componentPath = "pages/category/index", _temp2);
...
/***/ "./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=D:\\taro\\yanxuan\\src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js?!./src/pages/category/index.jsx?taro&type=template&parse=PAGE&":
/*!**********************************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/file-loader/dist/cjs.js?name=[path][name].wxml&context=D:/taro/yanxuan/src!./node_modules/@tarojs/mini-runner/dist/loaders/miniTemplateLoader.js!./node_modules/@tarojs/mini-runner/dist/loaders/wxTransformerLoader.js??ref--6-0!./src/pages/category/index.jsx?taro&type=template&parse=PAGE& ***!
  \**********************************************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
/* harmony import */ var _index_jsx_taro_type_template_parse_PAGE___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./index.jsx?taro&type=template&parse=PAGE& */ "./src/pages/category/index.jsx?taro&type=template&parse=PAGE&");
/* harmony import */ var _index_jsx_taro_type_script_parse_PAGE___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./index.jsx?taro&type=script&parse=PAGE& */ "./src/pages/category/index.jsx?taro&type=script&parse=PAGE&");
...
/***/ "./src/pages/category/index.jsx?taro&type=script&parse=PAGE&":
/*!*******************************************************************!*\
  !*** ./src/pages/category/index.jsx?taro&type=script&parse=PAGE& ***!
  \*******************************************************************/
/*! no static exports found */
...
/***/ "./src/pages/category/index.jsx?taro&type=template&parse=PAGE&":
/*!*********************************************************************!*\
  !*** ./src/pages/category/index.jsx?taro&type=template&parse=PAGE& ***!
  \*********************************************************************/
/*! no static exports found */
...
},[["./src/pages/category/index.jsx","runtime","vendors","common"]]]);